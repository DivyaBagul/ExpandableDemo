...
public class MainActivity extends AppCompatActivity {
    ...
    List<String> listDataHeader;//Collection of string type named as listDataHeader
    HashMap<String, List<String>> listDataChild;//Hashmap is used for sub headers
        ...
        expListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Toast.makeText(
                        ...
                        .show();
                if(childPosition==2)
                    Toast.makeText(MainActivity.this, "GOOD EVENING", Toast.LENGTH_SHORT).show();
    ...
    private void prepareListData() {
        listDataHeader = new ArrayList<>();//arrayList will store listdataHeader data
        listDataChild = new HashMap<>();//it keeps track of key and value(lock nd key)
